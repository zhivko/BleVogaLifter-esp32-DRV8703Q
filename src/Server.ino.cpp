# 1 "c:\\users\\klemen\\appdata\\local\\temp\\tmpxo29ct"
#include <Arduino.h>
...
# 171 "C:/Users/klemen/Dropbox/Voga/BleVogaLifter-esp32-DRV8703Q/src/Server.ino"
  ledcWrite(channel, _min(value, valueMax));

}
# 183 "C:/Users/klemen/Dropbox/Voga/BleVogaLifter-esp32-DRV8703Q/src/Server.ino"
...
void loop();
void move();
#line 245 "C:/Users/klemen/Dropbox/Voga/BleVogaLifter-esp32-DRV8703Q/src/Server.ino"
void clearFault()
...
# 275 "C:/Users/klemen/Dropbox/Voga/BleVogaLifter-esp32-DRV8703Q/src/Server.ino"
...

{
  ...
  vspi->beginTransaction(SPISettings(spiClk, MSBFIRST, SPI_MODE1));
# 309 "C:/Users/klemen/Dropbox/Voga/BleVogaLifter-esp32-DRV8703Q/src/Server.ino"
...

{
  ...
  vspi->beginTransaction(SPISettings(spiClk, MSBFIRST, SPI_MODE1));
# 497 "C:/Users/klemen/Dropbox/Voga/BleVogaLifter-esp32-DRV8703Q/src/Server.ino"
  byte data_read = B10000000;
...
# 923 "C:/Users/klemen/Dropbox/Voga/BleVogaLifter-esp32-DRV8703Q/src/Server.ino"
    } else {
...
# 981 "C:/Users/klemen/Dropbox/Voga/BleVogaLifter-esp32-DRV8703Q/src/Server.ino"
        }
...
void setup(){
  ...
  ArduinoOTA.begin();
# 1289 "C:/Users/klemen/Dropbox/Voga/BleVogaLifter-esp32-DRV8703Q/src/Server.ino"
